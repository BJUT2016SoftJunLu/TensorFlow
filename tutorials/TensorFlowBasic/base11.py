...
"""
(dynamic or static) LSTM RNN 图像分类
"""
...
init_state = lstm_cell.zero_state(100,dtype=np.float32)
...
outputs,final_state = tf.nn.dynamic_rnn(lstm_cell,input_datas,initial_state=init_state)
